...
export { default as GameStatusBar } from './GameStatusBar.vue';
...
export { default as FinishResultsModal } from './FinishResultsModal.vue';
...
export { default as StepHelpModal } from './StepHelpModal.vue';
